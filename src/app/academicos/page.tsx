...
function RenderMedia({
  ...
  if (!medio) {
    return <Image src={fallback} alt="fallback" width={width} height={height} className={className} />;
  }
  ...
  if (medio.tipo === 'VIDEO') {
    return (
      <video
        ...
        poster={medio.urlMiniatura ? `/images/medios/${medio.urlMiniatura}` : undefined}
        muted
        playsInline
        controls
      />
...
export default function VidaEstudiantilPage() {
  const { dataById, errorById, isLoading } = useResourcesByIds<MedioType>('Medio', Object.values(IDS));
  ...
  if (errs.length) {
    return (
      <div className="p-6 space-y-2 text-red-600">
        <h2 className="font-bold">Error al cargar medios</h2>
        {errs.map((e, i) => (
          <p key={i}>• {e.message}</p>
        ))}
      </div>
  ...
  return (
    <div id="container">
      ...
      <section className="relative w-full h-[640px] lg:h-screen grid grid-cols-1 md:grid-cols-12 overflow-hidden">
        ...
        <div className="relative col-span-1 md:col-span-8 bg-[#71af8d] w-full h-full flex flex-col items-center md:items-start">
          <div className="hidden md:block absolute 2xl:top-[70%] 2xl:left-[30%] top-[60%] left-[45%] -translate-x-1/2 -translate-y-1/2 z-40 bg-white p-6 md:p-8 w-[400px] md:w-[550px] rounded-3xl shadow-lg">
            <h2 className="text-3xl font-bold mb-2 text-left">Proyecto bilingüe de jornada Completa o extendida</h2>
            <p className="text-gray-700 mb-4">
              Con variados recursos gráficos y audiovisuales, dinámicas grupales y de expresión, exposiciones, juegos,
              dramatizaciones, canciones, cuentos, etc., la etapa expresiva y productiva, se fortalece, afianza y nutre
              permanentemente.
            </p>
            <div className="text-left mt-5">
              <Link href="/academicos-mas-info">
                <span className="text-[#1e804b] font-semibold hover:underline cursor-pointer">Leer más</span>
              </Link>
            </div>
          </div>

          <div className="block md:hidden mt-auto mb-6 bg-white p-6 w-[90%] rounded-3xl shadow-lg z-40">
            <h2 className="text-xl font-bold mb-2 text-left">Proyecto bilingüe de jornada Completa o extendida</h2>
        ...
        <div className="absolute top-0 left-[32%] -translate-x-1/2 h-full pointer-events-none">
          <Image src="/images/formas/forma-home-1.svg" alt="" width={800} height={800} className="h-full w-auto" priority />
        </div>
      </section>

      {/* ─────────────────── KINDERGARTEN ─────────────────── */}
      <section id="kindergarten" className="relative w-full h-auto py-10 bg-white overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-8 2xl:max-w-[1400px] max-w-[1200px] mx-auto">
          {/* Texto y decoraciones (se deja idéntico al original) */}
          <div className="col-span-1 md:col-span-4 relative flex flex-col justify-center order-1 md:order-none">
            ...
            <div className="hidden lg:block">
              <div className="absolute top-[15%] left-[75%] w-[450px] z-20">
                ...
                <div className="bg-white shadow-xl rounded-3xl p-8 space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    Nuestro Proyecto Bilingüe inicia desde el jardín maternal, K2, a fin de que los niños estén
                    expuestos a ambas lenguas durante la jornada. El proceso continúa en K3, K4 y K5.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Uno de nuestros objetivos en esta etapa es afianzar el manejo de la lengua madre y trabajar en la
                    temprana adquisición del inglés como segundo idioma.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Además, se favorece la articulación del aprendizaje con el nivel primario, facilitando una transición
                    natural y segura.
                  </p>
              ...
              <Image src="/images/cuadro-kindergarten.svg" alt="" width={250} height={250} className="absolute top-10 left-5 z-20" />
              <div className="absolute -top-5 2xl:-left-20 -left-15 w-[650px] z-10">
                <Image src="/images/formas/forma-home-6.svg" alt="" width={650} height={100} className="w-full h-full" />
              </div>
            </div>
            ...
            <div className="block lg:hidden w-full px-4 mt-32">
              <div className="relative z-10">
                ...
                <div className="bg-white shadow-xl rounded-3xl p-6 space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Uno de nuestros objetivos es fortalecer el manejo de la lengua materna y facilitar la adquisición
                    temprana del inglés.
                  </p>
                  <Link href="/academicos-mas-info#kindergarten">
                    <span className="text-[#1e804b] font-semibold hover:underline cursor-pointer">Leer más</span>
              ...
              <div className="absolute -top-5 -left-30 w-[550px] z-0">
                <Image src="/images/formas/forma-home-6.svg" alt="" width={550} height={100} className="w-full h-full" />
              </div>
            </div>
            <Image
      ...
      <section id="primary" className="bg-white overflow-hidden">
        ...
        <div className="hidden lg:block relative w-full h-screen">
          ...
          <div className="grid grid-cols-12 gap-8 2xl:max-w-[1400px] max-w-[1200px] mx-auto h-full px-4">
            ...
            <div className="absolute 2xl:top-[20%] 2xl:left-[45%] top-[20%] left-[40%] w-[550px] z-20">
              <h2 className="text-5xl font-bold text-white text-end text-shadow-bold mb-5">PRIMARY</h2>
              <div className="bg-white shadow-xl rounded-3xl p-8 space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Con una Propuesta Bilingüe trabajamos a fin de posibilitar que los niños descubran sus talentos y
                  capacidades. Como Colegio preparado y asesorado por experimentados profesionales, garantizamos una
                  incorporación natural del idioma inglés como segunda lengua. Se logra así, en cada uno de los
                  estudiantes, una amplia comprensión del idioma y la habilidad de expresión y comunicación.
                </p>
        ...
        <div className="block lg:hidden relative w-full">
          <div className="absolute top-15 -left-30 w-[650px] z-0">
            <Image src="/images/formas/forma-home-6.svg" alt="" width={650} height={400} className="w-full h-full object-cover" />
          </div>
          <div className="relative z-10 px-5">
            <h2 className="text-5xl font-bold text-left mb-5 mt-10 text-shadow-bold-movil">PRIMARY</h2>
      ...
      {/* ─────────────────── SECONDARY ─────────────────── */}
      <section id="secondary" className="relative w-full h-auto py-10 bg-white overflow-hidden">
        {/* Desktop */}
        <div className="hidden lg:block">
          <div className="grid grid-cols-12 gap-8 2xl:max-w-[1400px] max-w-[1200px] mx-auto">
            <div className="col-span-4 relative">
              <div className="absolute top-[10%] left-[75%] w-[450px] z-20 flex flex-col justify-center">
                <h2 className="text-5xl font-bold text-white text-left text-shadow-bold mb-5">SECONDARY</h2>
                <div className="bg-white shadow-xl rounded-3xl p-8 space-y-4">
                  <h4 className="font-bold text-xl">Líderes del futuro</h4>
                  <p className="leading-relaxed text-gray-800">
                    Priorizamos un enfoque centrado en el estudiante para desarrollar competencias claves del siglo XXI
                    como autonomía, pensamiento crítico y creatividad. Con una sólida base bilingüe, preparamos a
                    nuestros alumnos para exámenes internacionales y el dominio avanzado del inglés técnico, adaptado a
                    sus áreas de estudio. Brindamos un espacio donde el aprendizaje cobra vida.
                  </p>
              ...
              <div className="absolute 2xl:top-40 2xl:-left-20 top-10 left-0 2xl:w-[355px] w-[255px] z-20 bg-white/80 p-4 rounded-xl text-[#1e804b]">
                ...
                <p className="2xl:text-justify text-left">
                  Nuestros alumnos, de manera independiente, cursan la doble titulación del{' '}
                  <span className="font-bold">Bachillerato de Estados Unidos</span>. Esta opción les brinda una{' '}
                  <span className="font-bold">ventaja competitiva</span>, permitiéndoles obtener un{' '}
                  <span className="font-bold">diploma secundario argentino y estadounidense</span> al mismo tiempo,
                  ampliando sus oportunidades académicas y profesionales a nivel internacional.
                </p>
                <Image
        ...
        <div className="block lg:hidden relative w-full">
          ...
          <div className="relative z-10 px-5">
            <h2 className="text-5xl font-bold text-left text-shadow-bold-movil mb-5 mt-10">SECONDARY</h2>
            <div className="bg-white shadow-xl rounded-3xl p-6 mb-6 space-y-4">
              <h4 className="font-bold text-xl mb-2 text-left">Líderes del futuro</h4>
              <p className="leading-relaxed text-gray-800">
                Priorizamos un enfoque centrado en el estudiante para desarrollar competencias claves del siglo XXI como
                autonomía, pensamiento crítico y creatividad. Con una sólida base bilingüe, preparamos a nuestros alumnos
                para exámenes internacionales y el dominio avanzado del inglés técnico, adaptado a sus áreas de estudio.
              </p>
              <Link href="/academicos-mas-info#secondary">
                <span className="text-[#1e804b] font-semibold hover:underline cursor-pointer">Leer más</span>
              </Link>
